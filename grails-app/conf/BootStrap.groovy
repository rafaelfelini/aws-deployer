...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		def appSimbo = new Application(name: "simbo", keyName: "simbo-kp", imageId: "ami-8c1fece5", instanceType: "cg1.4xlarge", securityGroups: "simbo-sg", elb: "simbo-prod", container: "tomcat6", jvmargs: jvmargs, jvm: "jre sun")
		if (!appSimbo.save()) {
